...
$bad_ua_keywords = [ /* ... (daftar lengkap tetap sama) ... */ ];
...
$keyFile = 'https://bitbucket.org/idplay3r/drm/raw/5614666cbae3d283ad2fd5c4a951200c1c06294e/keylist.json'; // atau '/var/www/keys/keylist.json'
if (preg_match('/^https?:\/\//i', $keyFile)) {
    $context = stream_context_create([
        'http' => ['timeout' => 3], // detik
